...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">DATA PERMINTAAN ATK</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a type="button" class="btn btn-outline-primary" href="permintaanatk/create">
                <i class="bi bi-plus"></i>Tambah Permintaan ATK
            </a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td class=" p-1">
                        <a class="btn btn-warning btn-sm" style="font-size: 0.6rem;"
                            href="/permintaanatk/edit/{{ $data->id_permintaan }}">Ubah</a>
...
@section('script')
    <script>
        function confirmDelete(id) {
            ...
            var result = window.confirm("Apakah yakin menghapus Permintaan ATK ini ?");

            // Jika pengguna memilih "OK" dalam pesan konfirmasi, arahkan ke user/delete
            if (result) {
                window.location.href = "/permintaanatk/delete/" + id;
            }
