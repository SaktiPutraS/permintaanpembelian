...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">INPUT PESANAN PEMBELIAN (PO)</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a type="button" class="btn btn-outline-primary" href="/pesananpembelian">
                <i class="bi bi-box-arrow-left"></i> Kembali ke List Pesanan Pembelian
            </a>
        </div>
    </div>
    <form action="/pesananpembelian/save" method="POST" autocomplete="off">
        @csrf
        <div class="row">
